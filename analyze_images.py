...
def find_image_references_in_code(project_dir):
    ...
    for root, dirs, files in os.walk(project_dir):
        ...
        dirs[:] = [d for d in dirs if not d.startswith('.') and d not in ['node_modules', 'staticfiles', '__pycache__', '.git']]
                ...
                try:
                    ...
                    for pattern in patterns:
                        ...
                        for match in matches:
                            ...
                            if any(clean_match.lower().endswith(ext) for ext in ['.png', '.jpg', '.jpeg', '.svg', '.gif', '.ico', '.webp']):
