...
class AutomationEngine:
    ...
    def load_default_rules(self):
        ...
        self.add_rule(AutomationRule(
            ...
            conditions=[
                {"field": "title", "operator": "contains_any", "value": ["erro", "bug", "falha", "sistema", "login"]},
        ...
        self.add_rule(AutomationRule(
            ...
            conditions=[
                {"field": "status", "operator": "in", "value": ["NOVO", "ABERTO", "EM_ANDAMENTO"]}
            ],
            actions=[
                {"type": ActionType.ESCALATE.value, "params": {"level": "supervisor"}},
                {"type": ActionType.CHANGE_PRIORITY.value, "params": {"priority": "ALTA"}},
                {"type": ActionType.SEND_EMAIL.value, "params": {"template": "sla_breach", "recipients": ["supervisor"]}}
            ],
            priority=20
        ))
        ...
        self.add_rule(AutomationRule(
            ...
            trigger_type=TriggerType.TICKET_CREATED,
            conditions=[
                {"field": "priority", "operator": "in", "value": ["ALTA", "CRITICA"]}
            ],
            actions=[
        ...
        self.add_rule(AutomationRule(
            ...
            actions=[
                ...
                {"type": ActionType.SEND_EMAIL.value, "params": {"template": "auto_closed", "recipients": ["customer"]}}
            ],
            priority=5
        ))
        ...
        self.add_rule(AutomationRule(
            ...
            actions=[
                ...
                {"type": ActionType.CREATE_NOTIFICATION.value, "params": {"type": "spam_alert", "supervisors": True}}
            ],
            priority=25
        ))
