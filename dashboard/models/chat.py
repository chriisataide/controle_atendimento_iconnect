...
class ChatRoom(models.Model):
    ...
    ticket = models.ForeignKey(
        "Ticket", on_delete=models.CASCADE, null=True, blank=True, verbose_name="Ticket Relacionado"
    )
...
class ChatParticipant(models.Model):
    ...
    last_read_message = models.ForeignKey(
        "ChatMessage", on_delete=models.SET_NULL, null=True, blank=True, related_name="read_by_participants"
    )
    ...
    def unread_count(self):
        ...
        return (
            self.room.messages.filter(created_at__gt=self.last_read_message.created_at)
...
class ChatMessage(models.Model):
    ...
    reply_to = models.ForeignKey(
        "self", on_delete=models.SET_NULL, null=True, blank=True, related_name="replies", verbose_name="Resposta a"
    )
    forwarded_from = models.ForeignKey(
        "self", on_delete=models.SET_NULL, null=True, blank=True, related_name="forwards", verbose_name="Encaminhada de"
    )
...
class ChatSettings(models.Model):
    ...
    theme = models.CharField(
        max_length=20, default="light", choices=[("light", "Claro"), ("dark", "Escuro"), ("auto", "Automático")]
    )
    font_size = models.CharField(
        max_length=10, default="medium", choices=[("small", "Pequeno"), ("medium", "Médio"), ("large", "Grande")]
    )
