...
class ChatbotMessage(models.Model):
    ...
    conversa = models.ForeignKey(
        ChatbotConversation, on_delete=models.CASCADE, related_name="mensagens", verbose_name="Conversa"
    )
    ...
    confianca = models.DecimalField(
        max_digits=3, decimal_places=2, null=True, blank=True, verbose_name="Confiança da Resposta"
    )
...
class ChatbotAnalytics(models.Model):
    ...
    satisfacao_media = models.DecimalField(
        max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Satisfação Média"
    )
    tempo_resposta_medio = models.DecimalField(
        max_digits=8, decimal_places=2, null=True, blank=True, verbose_name="Tempo Resposta Médio (s)"
    )
