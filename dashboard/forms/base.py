...
from ..models import CategoriaTicket, Cliente, Ticket
from ..utils.rbac import ALL_ROLES, ROLE_ADMIN, ROLE_AGENTE, UserRole, assign_role, get_user_role
...
class DashboardUserCreationForm(UserCreationForm):
    ...
    first_name = forms.CharField(
        required=False, widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Primeiro nome"})
    )
    last_name = forms.CharField(
        required=False, widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Último nome"})
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.request_user and not self.request_user.is_superuser:
            self.fields["role"].choices = [(val, label) for val, label in UserRole.ROLE_CHOICES if val != ROLE_ADMIN]
...
class CustomLoginForm(AuthenticationForm):
    ...
    remember_me = forms.BooleanField(
        required=False, widget=forms.CheckboxInput(attrs={"class": "form-check-input", "id": "rememberMe"})
    )
...
class QuickTicketForm(forms.Form):
    ...
    title = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Descreva o problema brevemente", "autocomplete": "off"}
        ),
    )
    ...
    description = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={"class": "form-control", "rows": 4, "placeholder": "Descreva o problema com mais detalhes..."}
        ),
    )
...
class MobileCommentForm(forms.Form):
    ...
    comment = forms.CharField(
        ...
        widget=forms.Textarea(attrs={"class": "form-control", "rows": 3, "placeholder": "Digite seu comentário..."}),
    )
...
class TicketForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "titulo": forms.TextInput(attrs={"class": "form-control", "placeholder": "Título do ticket"}),
...
class TicketCreateForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "categoria": forms.Select(attrs={"class": "form-control", "id": "categoriaSelect"}),
            "tipo": forms.Select(attrs={"class": "form-control", "id": "tipoSelect"}),
            "titulo": forms.TextInput(
                attrs={"class": "form-control", "id": "tituloInput", "placeholder": "Título do ticket"}
            ),
            "descricao": forms.Textarea(
                attrs={"class": "form-control", "rows": 5, "placeholder": "Descrição detalhada do problema"}
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["ponto_de_venda"].queryset = (
            PontoDeVenda.objects.select_related("cliente").all().order_by("nome_fantasia")
        )
...
class ClienteForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "segmento": forms.TextInput(attrs={"class": "form-control", "placeholder": " "}),
            "email": forms.EmailInput(attrs={"class": "form-control", "placeholder": " "}),
            "telefone": forms.TextInput(attrs={"class": "form-control", "placeholder": " "}),
            "observacoes": forms.Textarea(attrs={"class": "form-control", "placeholder": " ", "rows": 3}),
