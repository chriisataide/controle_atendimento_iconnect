...
class TicketAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("numero", "titulo", "descricao", "cliente", "categoria")}),
        ("Atribuição", {"fields": ("agente", "status", "prioridade")}),
        (
            "Timestamps",
            {"fields": ("criado_em", "atualizado_em", "resolvido_em", "fechado_em"), "classes": ("collapse",)},
        ),
    )
...
class PerfilUsuarioAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Usuário", {"fields": ("user",)}),
        ("Informações de Contato", {"fields": ("telefone", "telefone_alternativo")}),
        ("Endereço", {"fields": ("endereco", "cidade", "estado", "cep")}),
        ("Informações Profissionais", {"fields": ("cargo", "departamento", "bio")}),
        ("Avatar", {"fields": ("avatar",)}),
        (
            "Metadados",
            {"fields": ("perfil_completo_percentual", "criado_em", "atualizado_em"), "classes": ("collapse",)},
        ),
    )
...
class EquipamentoAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identificação", {"fields": ("numero_serie", "tipo", "marca", "modelo", "patrimonio", "descricao")}),
        ("Localização", {"fields": ("ponto_de_venda", "local_instalacao")}),
        ("Status e Datas", {"fields": ("status", "data_instalacao", "data_garantia", "data_desativacao")}),
        ("Contadores", {"fields": ("total_chamados", "total_trocas"), "classes": ("collapse",)}),
