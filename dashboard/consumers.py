...
from .models import (
    Ticket, Notification, Cliente, InteracaoTicket, PerfilAgente,
...
class NotificationConsumer(AsyncWebsocketConsumer):
    ...
    def get_dashboard_statistics(self):
        ...
        active_agents = PerfilAgente.objects.filter(
...
class DashboardConsumer(AsyncWebsocketConsumer):
    ...
    async def send_dashboard_update(self):
        ...
        try:
            from .models import Ticket, PerfilUsuario
    ...
    def check_room_access(self):
        ...
        try:
            ...
            participant = ChatParticipant.objects.filter(
                room=room, user=self.user, is_active=True
            ).exists()
