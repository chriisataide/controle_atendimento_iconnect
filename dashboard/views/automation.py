...
def automation_dashboard(request):
            ...
            if data.get("action") == "activate_template":
                ...
                TEMPLATE_CONFIGS = {
                    ...
                    "escalation": {
                        ...
                        "actions": [
                            {"type": "escalate", "value": "supervisor"},
                            {"type": "change_priority", "value": "alta"},
                        ],
                        "priority": 7,
                    },
                    "email_notify": {
                    ...
                    "auto_resolve": {
                        ...
                        "actions": [
                            {"type": "change_status", "value": "fechado"},
                            {"type": "add_comment", "value": "Ticket fechado automaticamente após 72h sem interação."},
                        ],
                        "priority": 3,
                    },
                }
    ...
    for i in range(6, -1, -1):
        ...
        chart_data.append(WorkflowExecution.objects.filter(created_at__date=day).count())
...
def automation_rules(request):
    ...
    return render(
        request,
        "dashboard/automation/rules.html",
        {
...
def automation_workflows(request):
            ...
            if action == "create":
                ...
                QUICK_TEMPLATES = {
                    "auto_assign_high_priority": {
                        ...
                        "actions": [
                            {"type": "assign_agent", "value": "auto"},
                            {"type": "send_notification", "value": "Ticket de alta prioridade atribuído"},
                        ],
                        "priority": 9,
                    },
                    "escalate_old_tickets": {
                        ...
                        "actions": [
                            {"type": "escalate", "value": "supervisor"},
                            {"type": "change_priority", "value": "urgente"},
                        ],
                        "priority": 8,
                    },
                    "close_resolved_tickets": {
                        ...
                        "actions": [
                            {"type": "change_status", "value": "fechado"},
                            {"type": "add_comment", "value": "Ticket fechado automaticamente."},
                        ],
                        "priority": 4,
                    },
                }
    ...
    return render(
        request,
        "dashboard/automation/workflows.html",
        {
