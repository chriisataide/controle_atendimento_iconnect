...
VAPID_CLAIMS = getattr(
    settings, "VAPID_CLAIMS", {"sub": "mailto:" + getattr(settings, "DEFAULT_FROM_EMAIL", "noreply@iconnect.com")}
)
...
def get_public_key(request):
    ...
    return JsonResponse({"public_key": VAPID_PUBLIC_KEY, "status": "active"})
...
def subscribe_push(request):
    ...
    try:
        ...
        return JsonResponse({"success": True, "message": "Subscription successful", "subscription_id": subscription.id})
        ...
        return JsonResponse({"success": True, "created": True, "subscription_id": 1, "status": "mock"})
...
def unsubscribe_push(request):
    ...
    try:
        ...
        return JsonResponse({"success": True, "deleted": True, "status": "mock"})
...
def test_notification(request):
    ...
    try:
        ...
        return JsonResponse({"success": True, "sent": 1, "failed": 0, "status": "mock"})
