...
from .models_chatbot_ai import ChatbotKnowledgeBase, ChatbotConversation, ChatbotMessage, ChatbotConfiguration
...
class ChatbotAIEngine:
    ...
    def add_training_data(self, question: str, bot_response: str, expected_response: str = None, 
        ...
        from .models_chatbot_ai import ChatbotTraining
