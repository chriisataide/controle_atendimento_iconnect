...
urlpatterns = [
    ...
    path('api/chat/<uuid:room_id>/create-ticket/', chat.api_create_ticket_from_chat, name='api_create_ticket_from_chat'),
    ...
    path('chatbot-ai/conversation/<uuid:conversation_id>/', chatbot_ai.chatbot_conversation_detail, name='chatbot_ai_conversation_detail'),
    ...
    path('api/chatbot/create-ticket/', chatbot_ai.chatbot_create_ticket_from_conversation, name='chatbot_ai_create_ticket'),
