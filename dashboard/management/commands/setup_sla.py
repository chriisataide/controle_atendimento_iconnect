...
from dashboard.models import CategoriaTicket, PrioridadeTicket, SLAPolicy
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        categoria_tecnico, _ = CategoriaTicket.objects.get_or_create(
            nome="Técnico", defaults={"descricao": "Problemas técnicos e suporte", "cor": "#007bff"}
        )

        categoria_comercial, _ = CategoriaTicket.objects.get_or_create(
            nome="Comercial", defaults={"descricao": "Questões comerciais e vendas", "cor": "#28a745"}
        )

        categoria_financeiro, _ = CategoriaTicket.objects.get_or_create(
            nome="Financeiro", defaults={"descricao": "Questões financeiras e cobrança", "cor": "#ffc107"}
        )
