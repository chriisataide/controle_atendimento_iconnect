...
urlpatterns = [
    ...
    path(
        "ticket/<int:ticket_id>/status/", mobile_views.mobile_ticket_status_update, name="mobile_ticket_status_update"
    ),
    path("ticket/<int:ticket_id>/comment/", mobile_views.mobile_ticket_comment, name="mobile_ticket_comment"),
    path(
        "ticket/<int:ticket_id>/upload-photo/",
        mobile_views.mobile_ticket_upload_photo,
        name="mobile_ticket_upload_photo",
    ),
