...
class SSOSessionModelTest(TestCase):
    def test_expired(self):
        provider = SSOProvider.objects.create(
            name='Test', slug='test', protocol='oidc',
            client_id='x', authorization_url='https://example.com/auth',
    ...
    def test_not_expired(self):
        provider = SSOProvider.objects.create(
            name='Test2', slug='test2', protocol='oidc',
            client_id='x', authorization_url='https://example.com/auth',
            token_url='https://example.com/token',
            userinfo_url='https://example.com/userinfo',
        )
...
class SSOEngineTest(TestCase):
    def test_get_active_providers(self):
        SSOProvider.objects.create(
            name='Active', slug='active', protocol='oidc',
            is_active=True, client_id='x',
            authorization_url='https://example.com/auth',
            token_url='https://example.com/token',
            userinfo_url='https://example.com/userinfo',
        )
        SSOProvider.objects.create(
            name='Inactive', slug='inactive', protocol='oidc',
            is_active=False, client_id='x',
            authorization_url='https://example.com/auth',
            token_url='https://example.com/token',
            userinfo_url='https://example.com/userinfo',
        )
    ...
    def test_provision_creates_user(self):
        provider = SSOProvider.objects.create(
            name='Test', slug='test-p', protocol='oidc',
            client_id='x', auto_create_user=True,
            authorization_url='https://example.com/auth',
            token_url='https://example.com/token',
            userinfo_url='https://example.com/userinfo',
        )
    ...
    def test_provision_refuses_when_disabled(self):
        provider = SSOProvider.objects.create(
            name='Test', slug='test-no-create', protocol='oidc',
            client_id='x', auto_create_user=False,
            authorization_url='https://example.com/auth',
            token_url='https://example.com/token',
            userinfo_url='https://example.com/userinfo',
        )
...
class SSOViewTest(TestCase):
    def test_provider_list_json(self):
        SSOProvider.objects.create(
            name='Google', slug='google', protocol='oidc',
            is_active=True, client_id='x',
