    ...
    def _generate_response(self, message: str, intent: str, conversation: ChatbotConversation) -> Dict:
        ...
        if intent == "greeting":
            return {
                ...
                "confidence": 1.0,
                "suggestions": ["Verificar status do meu ticket", "Criar um novo chamado", "Falar com um atendente"],
            }

        elif intent == "farewell":
            return {"text": "Até logo! 👋 Se precisar de mais alguma coisa, estarei aqui.", "confidence": 1.0}
            ...
            return {
                ...
                "confidence": 1.0,
                "suggestions": ["Status do ticket", "Novo chamado", "Falar com atendente"],
            }
        ...
        return {
            ...
            "suggestions": ["Falar com atendente", "Ver perguntas frequentes", "Tentar reformular a pergunta"],
        }
