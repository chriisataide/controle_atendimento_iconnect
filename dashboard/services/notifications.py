...
class NotificationService:
    ...
    def __init__(self):
        ...
        self.notification_types = {
            "new_ticket": {"title": "Novo Ticket Criado", "icon": "add_circle", "color": "primary"},
            "ticket_assigned": {"title": "Ticket Atribuído", "icon": "assignment", "color": "info"},
            "ticket_status_change": {"title": "Status do Ticket Alterado", "icon": "update", "color": "warning"},
            "sla_warning": {"title": "Alerta de SLA", "icon": "warning", "color": "danger"},
            "new_interaction": {"title": "Nova Interação", "icon": "chat", "color": "success"},
        }
    ...
    def _send_whatsapp_notification(self, phone, event_type, context):
        ...
        try:
            ...
            whatsapp_messages = {
                "ticket_created": {"template": "ticket_created", "parameters": [ticket.numero, ticket.titulo]},
                "ticket_updated": {"template": "ticket_updated", "parameters": [ticket.numero, ticket.status.upper()]},
                "ticket_resolved": {"template": "ticket_resolved", "parameters": [ticket.numero]},
            }
