...
from .engine import calcular_valor_implantacao, get_empresas_disponiveis, VALORES_IMPLANTACAO
from .models import ProcessamentoHistorico

logger = logging.getLogger(__name__)

# Diretórios de trabalho
UPLOAD_DIR = getattr(settings, 'CALCULO_VIGILANTE_UPLOAD_DIR',
                     os.path.join(settings.BASE_DIR, 'uploads_calculo'))
OUTPUT_DIR = getattr(settings, 'CALCULO_VIGILANTE_OUTPUT_DIR',
                     os.path.join(settings.BASE_DIR, 'processados_calculo'))
...
def pagina_calculo(request):
    ...
    historico = ProcessamentoHistorico.objects.filter(
    ...
    return render(request, 'calculo_vigilante/calculo.html', {
